            ...
            <div class="row no-gutter">
                ...
                <div class="col-sm-5 col-md-6">
                    <ul class="quick-links">
                        <li><a href="" title="phổ biến"><i class="fa fa-star fa-2x"></i><br>phổ biến</a>
                        </li>
                        <li><a href="/them, sua, xoa/logincsdl.html" target="_blank" href="" title="thêm, sửa, xóa csdl"><i class="fa fa-line-chart fa-2x"></i><br>sửa csdl</a>
                        </li>
                        <li><a href="/login.html" title="đăng nhập"><i class="fa fa-history fa-2x fa-flip-horizontal"></i><br>đăng nhập</a>
                        </li>
                        <li><a href="" title="đăng xuất" class="random-person"><i class="fa fa-random fa-2x"></i><br>đăng xuất</a>
                        </li>
                    </ul>
                </div>
            </div>
