<?php $conn=mysqli_connect( "localhost", "root", "", "sinhnhatnoitieng"); mysqli_query($conn, "SET NAMES utf8"); $sql="select * from people where rank <13  " ; $sql0="select * from people where rank > 12 and rank <25  " ; $sql1="select * from people where rank > 24 and rank <37  " ; $sql2="select * from people where rank > 36 and rank <49  " ; $query=mysqli_query($conn,$sql); $query0=mysqli_query($conn,$sql0); $query1=mysqli_query($conn,$sql1); $query2=mysqli_query($conn,$sql2); ?>
<!-- connect -->
<!doctype html>
        ...
        pbjs.que.push(function() {
            ...
            var adUnits = [{
                ...
                , {
                    ...
                    sizes: (windowWidthForAds > szs.t ? (windowWidthForAds < szs.dl ? [
                        [728, 90]
                    ] : [
                        [970, 250],
                        [970, 90],
        ...
        */
        googletag.cmd.push(function() {
            ...
            if (windowWidthForAds < szs.dl) {
                ...
                googletag.defineSlot('/20602751/famousbirth-top-middle-leaderboard', [
                    [970, 250],
                    [970, 90],
                    [728, 90]
                ], 'div-gpt-ad-1391216460869-2').addService(googletag.pubads());


                googletag.defineSlot('/20602751/famousbirth-center-middle-leaderboard', [
                    [970, 250],
                    [970, 90],
                    [728, 90]
                ], 'div-gpt-ad-1423776989563-0').addService(googletag.pubads());


                googletag.defineSlot('/20602751/famousbirth-bottom-middle-leaderboard', [
                    [970, 250],
                    [970, 90],
                    [728, 90]
                ], 'div-gpt-ad-1391216734145-1').addService(googletag.pubads());


                googletag.defineSlot('/20602751/famousbirth-bottom-leaderboard', [
                    [970, 90],
                    [728, 90]
                ], 'div-gpt-ad-1391213528835-0').addService(googletag.pubads());
            ...
            <div class="row no-gutter">
                ...
                <div class="col-xs-10 col-sm-4">
                    <form id="fb_search" class="search" role="form" name="fb_search" action="/search" method="post">
                        ...
                        <button type="submit" class="btn btn-search" aria-label="Search" title="Tìm kiếm"><i class="fa fa-search fa-flip-horizontal"></i>
                        </button>
                    </form>
                </div>
                <div class="col-sm-5 col-md-6">
                    <ul class="quick-links">
                        <li><a href="/most-popular-people.php" title="phổ biến"><i class="fa fa-star fa-2x"></i><br>phổ biến</a>
                        </li>
                        <li><a href="/trending/" title="xu hướng"><i class="fa fa-line-chart fa-2x"></i><br>xu hướng</a>
                        </li>
                        <li><a href="/new/" title="gần đây"><i class="fa fa-history fa-2x fa-flip-horizontal"></i><br>gần đây</a>
                        </li>
                        <li><a id="random-person" href="#" title="ngẫu nhiên" class="random-person"><i class="fa fa-random fa-2x"></i><br>ngẫu nhiên</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div id="div-gpt-ad-1391210931444-0" class="adspot adspot1">
                            <script>
                                googletag.cmd.push(function() {
                                    googletag.display('div-gpt-ad-1391210931444-0');
                                });
                            </script>
                        </div>
                    </div>
            ...
            <div class="container people-list">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo $row['link'] ?>" class="face person-item" style="background: url(<?php echo $row['img'] ?>) no-repeat center center; background-size:cover;">
                        <i class="fa fa-star fa-rank fa-2x"><span class="rank"><?php echo $row['rank'] ?></span></i>
                        <div class="info">
                            <div class="name">
                                <?php echo $row[ 'name'] ?>
                                <?php echo $row[ 'age'] ?>
                ...
                <div class="row">
                    <div class="text-center">
                        <div id="div-gpt-ad-1391216460869-2" class="adspot adspot2">
                            <script>
                                googletag.cmd.push(function() {
                                    googletag.display('div-gpt-ad-1391216460869-2');
                                });
                            </script>
                        </div>
                    </div>
                ...
                <div class="row">
                    <?php while($row=mysqli_fetch_array($query0)) { ?>
                    <a href="<?php echo $row['link'] ?>" class="face person-item" style="background: url(<?php echo $row['img'] ?>) no-repeat center center; background-size:cover;">
                        <i class="fa fa-star fa-rank fa-2x"><span class="rank"><?php echo $row['rank'] ?></span></i>
                        <div class="info">
                            <div class="name">
                ...
                <div class="row">
                    <div class="text-center">
                        <div id="div-gpt-ad-1423776989563-0" class="adspot adspot2">
                            <script>
                                googletag.cmd.push(function() {
                                    googletag.display('div-gpt-ad-1423776989563-0');
                                });
                            </script>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="text-center">
                        <div id="div-gpt-ad-1391216734145-1" class="adspot adspot2">
                            <script>
                                googletag.cmd.push(function() {
                                    googletag.display('div-gpt-ad-1391216734145-1');
                                });
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="col-sm-6 cta-btn-container">
                                <a href="/trending" class="btn btn-primary btn-block btn-lg">Xu Hướng<span class="pull-right"><i class="fa fa-angle-right fa-2x"></i></span></a>
                            </div>
                            <div class="col-sm-6 cta-btn-container">
                                <a href="/profession/  " class="btn btn-primary btn-block btn-lg">Nghề Nghiệp<span class="pull-right"><i class="fa fa-angle-right fa-2x"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div id="div-gpt-ad-1391213528835-0" class="adspot adspot7">
                            <script>
                                googletag.cmd.push(function() {
                                    googletag.display('div-gpt-ad-1391213528835-0');
                                });
                            </script>
                        </div>
                    </div>
            ...
            <footer>
                <div class="row">
                    <div class="col-sm-6">
                        <ul class="social">
                            <li>
                                <a class="fa fa-twitter fa-3x" href="https://twitter.com/famousbirthdays" targe="_blank" title="Twitter Sinh Nhật Nổi Tiếng"></a>
                            </li>
                            <li>
                                <a class="fa fa-facebook fa-3x" href="https://www.facebook.com/FamousBirthdays" targe="_blank" title="Facebook  Sinh Nhật Nổi Tiếng"></a>
                            </li>
                            <li>
                                <a class="fa fa-instagram fa-3x" href="https://instagram.com/famousbirthdays" targe="_blank" title="Instagram  Sinh Nhật Nổi Tiếng"></a>
                            </li>
                            <li>
                                <a class="fa fa-apple fa-3x" href="https://itunes.apple.com/us/app/famous-birthdays-celebrity/id646707938" targe="_blank" title="Cài đặt ƯD iOS Sinh Nhật Nổi Tiếng"></a>
                            </li>
                            <li>
                                <a class="fa fa-android fa-3x" href="https://play.google.com/store/apps/details?id=com.famousbirthdays" targe="_blank" title="Cài đặt ƯD Android Sinh Nhật Nổi Tiếng"></a>
                            </li>
                        </ul>
                        <ul class="quick-links">
