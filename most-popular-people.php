            ...
            <div class="row no-gutter">
                ...
                <div class="col-xs-10 col-sm-4">
                    <form id="fb_search" class="search" role="form" name="fb_search" action="/search" method="post">
                        ...
                        <button type="submit" class="btn btn-search" aria-label="Search" title="Tìm kiếm"><i class="icn icn-search"></i>
                        </button>
                    </form>
                </div>
                <div class="col-sm-5 col-md-6">
                    <ul class="quick-links">
                        <li><a href="/most-popular-people.php" title="phổ biến"><i class="icn icn-star"></i>phổ biến</a>
                        </li>
                        <li><a href="/trending/" title="xu hướng"><i class="icn icn-trending"></i>xu hướng</a>
                        </li>
                        <li><a href="/new/" title="gần đây"><i class="icn icn-recent"></i>gần đây</a>
                        </li>
                        <li><a id="random-person" href="#" title="ngẫu nhiên" class="random-person"><i class="icn icn-random"></i>ngẫu nhiên</a>
                        </li>
                    </ul>
                </div>
            </div>
